...
from src.repositores.librarian import create_db_and_tables, create_user, update_status
...
def main():
    ...
    for number in range(len(all_users)):
        update_status(1, "Quests completed")
    ...
    for number in range(len(all_users)):
        update_status(1, "Rewards received")
